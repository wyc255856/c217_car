...
//        });
    ...
    public void onClick(View v) {
        ...
        if (str.equals("手动舒适")) {
            SharedpreferencesUtil.setCarModel(ManualSelecteCarActivity.this, "C217_1");
        } else if (str.equals("手动豪华")) {
            SharedpreferencesUtil.setCarModel(ManualSelecteCarActivity.this, "C217_2");
        } else if (str.equals("手动尊贵")) {
            SharedpreferencesUtil.setCarModel(ManualSelecteCarActivity.this, "C217_3");
        } else if (str.equals("自动舒适")) {
            SharedpreferencesUtil.setCarModel(ManualSelecteCarActivity.this, "C217_4");
